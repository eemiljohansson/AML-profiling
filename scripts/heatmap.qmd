...
ggsave("results/overlaps/AML_DE_Overlap_All.pdf", width = 20, height = 7)
```
...
ggsave("Heatmap DE and ML ordered.pdf", path = "results/heatmap/", width = 30, height = 5)
```
...
ggsave("Barplot DE significance.pdf", path = "results/heatmap/", width = 10, height = 7)
```
...
ggsave("Barplot DE logFC.pdf", path = "results/heatmap/", width = 10, height = 7)
```

```{r Combining bar plots, fig.width=20, fig.height=7}
bar_plot_sig + bar_plot_fold
ggsave("Barplots DE significance and logFC.pdf", path = "results/heatmap/", width = 20, height = 7)
```
